 ...
 * @author GREG-PC
 */
@WebServlet(urlPatterns = {"/Listar_Especialidades"})
public class Listar_Especialidades extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            DBCollection Info = Conexion.Documentos("Especialidades");
